...
const testimonials = [
  {
    quote: "Nexus Labs replaced three tools and made our release cycles 35% faster.",
    name: "Lena Park",
...
export default function LandingPage() {
  return (
    <main className="container pb-12 pt-10">
      ...
      >
        <motion.div variants={fadeUp} className="space-y-6">
          ...
          <p className="max-w-xl text-lg text-muted-foreground">
            Nexus Labs unifies product planning, execution, analytics, and collaboration in one stunningly fast SaaS workspace.
          </p>
      ...
      <footer className="py-14 text-sm text-muted-foreground">
        © {new Date().getFullYear()} Nexus Labs. Crafted for high-performing product teams.
      </footer>
    </main>
  );
}
